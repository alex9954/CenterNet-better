...
"""
dl_lib training script with a plain training loop.
This scripts reads a given config file and runs the training or evaluation.
It is an entry point that is able to train standard models in dl_lib.
...
from dl_lib.engine import default_argument_parser, default_setup, launch
from dl_lib.evaluation import (CityscapesEvaluator, COCOEvaluator,
...
from dl_lib.utils.events import (CommonMetricPrinter, EventStorage, JSONWriter,
                                 TensorboardXWriter)
from net import build_model

logger = logging.getLogger("dl_lib")
